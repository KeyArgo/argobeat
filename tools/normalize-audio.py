...
def main():
    ...
    # Default: both. --music: music only. --soundscape: soundscapes only.
    do_sc  = not args.music    # process soundscapes unless --music-only
    do_mus = not args.soundscape  # process music unless --soundscape-only
