...
VAULT = Path('/mnt/homes/galileo/argo/Vaults/argobox')
SESSIONS = VAULT / 'sessions'
INDEX_FILES = {
    'focus': VAULT / 'foc index.txt',
    'creative': VAULT / 'creative index.txt',
    'learn': VAULT / 'learn index.txt',
    'motivate': VAULT / 'motivate index.txt',
}
